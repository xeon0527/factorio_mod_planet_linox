...
require(__PATH__.."npc.power-converter");
require(__PATH__.."advanced-rocket-silo");
require(__PATH__.."cargo-elevator");
require(__PATH__.."cargo-landing-pad");
require(__PATH__.."chemical-filter");
...
require(__PATH__.."linox-supercomputer")
require(__PATH__.."mantle-extractor")
require(__PATH__.."neodymium-bulk-inserter")
require(__PATH__.."neodymium-permanent-magnet-generator")
require(__PATH__.."neodymium-stack-inserter")
require(__PATH__.."outlet")
